...
class uploads:public drogon::HttpController<uploads>
{
  public:
    ...
    METHOD_ADD(uploads::get,"/?fname={1}", Post);//path is /uploads/{arg2}/{arg1}
    ...
    void get(const HttpRequestPtr& req,std::function<void (const HttpResponsePtr &)> &&callback, std::string fname);
